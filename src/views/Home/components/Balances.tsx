...
import { getSushiSupply } from '../../../pot/utils'
...
const Balances: React.FC = () => {
  ...
  const { tronWeb, account, token } = useWallet()
  const sushiBalance = useTokenBalance(token)
  

  useEffect(() => {
    async function fetchTotalSupply() {
      const supply = await getSushiSupply(tronWeb, token)
  ...
  return (
    <StyledWrapper>
      ...
      <Card>
        ...
        <Footnote>
          All tokens can only be generated by contract
        </Footnote>
      </Card>
    </StyledWrapper>
  )
